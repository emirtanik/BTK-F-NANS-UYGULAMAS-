...
public class DemoDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        var item1 = portfolioItemRepository.save(PortfolioItem.builder()
        ...
        @SuppressWarnings({"null", "unused"})
        var item2 = portfolioItemRepository.save(PortfolioItem.builder()
        ...
        @SuppressWarnings({"null", "unused"})
        var item3 = portfolioItemRepository.save(PortfolioItem.builder()
        ...
        @SuppressWarnings({"null", "unused"})
        var item4 = portfolioItemRepository.save(PortfolioItem.builder()
        ...
        @SuppressWarnings({"null", "unused"})
        var item5 = portfolioItemRepository.save(PortfolioItem.builder()
        ...
        @SuppressWarnings({"null", "unused"})
        var alert1 = priceAlertRepository.save(PriceAlert.builder()
        ...
        @SuppressWarnings({"null", "unused"})
        var alert2 = priceAlertRepository.save(PriceAlert.builder()
